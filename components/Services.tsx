...
export default function TherapyServices() {
  ...
  return (
    <div className=" max-w-[1550px] px-0 mb-8 mx-auto py-16">
      <motion.h2
        className="text-4xl font-bold mt-[54px] text-center text-[#634AE2] mb-12"
      ...
      <div className="flex gap-[0.4px] md:flex-row flex-col">
        {services.map((service, index) => (
          ...
          >
            ...
            <h3 className="mt-3 mb-[39px] text-xl font-bold">
              {service.title}
            </h3>
