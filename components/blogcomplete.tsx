import { Button, Divider, Form, image, Image, User } from "@nextui-org/react";
...
const artículo=[
  ...
  {
    id:3,
    imagen:"/CarruselInferiorMain/brazos.webp",
    titulo:"Causas de la depresión en la adultez",
    descripcion:"La adultez es una etapa de grandes cambios y desafíos.",
    fecha:"Publicado el 17/07/2024"
  }
]
export default function BlogComplete() {
  return (
    <>
      ...
      <h1 className="text-[#634AE2] text-4xl font-semibold -ml-0">Blog</h1>
    </div>
          <Button
            radius="full"
